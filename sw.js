...
const CACHE = 'ttgd-v21';
const IMG_CACHE = 'ttgd-img-v3';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/style.css?v=20260915d',
  './js/storage.js?v=20260915d',
  './js/scheduler.js?v=20260915d',
  './js/anki.js?v=20260915d',
  './js/data.js?v=20260915d',
  './js/bundled_questions.js?v=20260915d',
  './js/bundled_imagecards.js?v=20260915d',
  './js/paper_data.js?v=20260915d',
  './js/img_ocr_index.js?v=20260915d',
  './js/match-engine.js?v=20260915d',
  './js/plan-data.js?v=20260915d',
  './js/app.js?v=20260915d',
  './js/vendor/supabase.min.js',
  './js/supabase-config.js?v=20260915d',
  './js/sync.js?v=20260915d',
  './js/ai.js?v=20260915d',
  './js/exam-fix.js?v=20260915d',
  './icons/icon.svg'
];
